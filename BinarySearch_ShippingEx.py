...
# dynamic programming
def ship_within_days_dp(weights, days):
    # Helper function to check if the current capacity is feasible within the given days
    def feasible(capacity):
        current_weight = 0
        required_days = 1
        for weight in weights:
...
print(ship_within_days(weights1, days1))  # Output: 15
print(ship_within_days(weights2, days2))  # Output: 6
print(ship_within_days_dp(weights3, days3))  # Output: 3
